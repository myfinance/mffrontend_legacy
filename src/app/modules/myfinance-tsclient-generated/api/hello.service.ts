...
export class HelloService {
    ...
    public getHello(observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
        ...
        return this.httpClient.get<string>(`${this.basePath}/hello`,
            {
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public getProducts(observe?: 'body', reportProgress?: boolean): Observable<string>;
    public getProducts(observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<string>>;
    public getProducts(observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<string>>;
    public getProducts(observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
        ...
        return this.httpClient.get<string>(`${this.basePath}/hello/list`,
            {
                withCredentials: this.configuration.withCredentials,
                headers: headers,
                observe: observe,
